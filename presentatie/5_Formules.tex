...
\begin{frame}{Equation}
	...
	\includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{%
		assets/5_Formules/mathEquation\langsuffix.pdf}
...
\begin{frame}{Align}
	...
	\includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{%
		assets/5_Formules/mathAlignUnaligned\langsuffix.pdf}
\end{frame}
...
\begin{frame}{Align}
	...
	\includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{%
		assets/5_Formules/mathAlignDoubleNumber\langsuffix.pdf}
\end{frame}
...
\begin{frame}{Align}
	...
	\includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{%
		assets/5_Formules/mathAlignSecondNumbered\langsuffix.pdf}
\end{frame}
...
\begin{frame}{Align}
	...
	\includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{%
		assets/5_Formules/mathAlignNoNumbers\langsuffix.pdf}
\end{frame}
...
\begin{frame}{Align}
	...
	\includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{%
		assets/5_Formules/mathTag\langsuffix.pdf}
\end{frame}
...
\begin{frame}{Align}
	...
	\centering\includegraphics[width=\linewidth,height=0.3\textheight,keepaspectratio]{
		assets/5_Formules/mathAlignBroken\langsuffix.pdf}
\end{frame}
...
\begin{frame}{Align}
	...
	\centering\includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{
		assets/5_Formules/mathAlignIntertext\langsuffix.pdf}
\end{frame}
