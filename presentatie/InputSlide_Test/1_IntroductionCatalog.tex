...
\def\assetdir{assets/1_Inleiding}
\def\assetdir{slides/intro/assets}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{columns}
            \begin{column}{0.5\textwidth}
                \includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{\assetdir/basicDocWordSnippet.png}
            \end{column}
            \begin{column}{0.5\textwidth}
                \includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{\assetdir/basicDocLaTeXSnippet.png}
            \end{column}
        \end{columns}
    \end{frame}
    ...
    \begin{frame}
        ...
        \fbox{\includegraphics[width=\linewidth,height=0.5\textheight,keepaspectratio]{\assetdir/basicDocWordSnippetEq.png}}
        \medskip

        \fbox{\includegraphics[width=\linewidth,height=0.5\textheight,keepaspectratio]{\assetdir/basicDocLaTeXSnippetEq.png}}
        \egroup
    \end{frame}
        ...
        \begin{columns}[t]%
            ...
            \begin{column}{0.4\textwidth}%
                \adjustbox{fbox=0.5pt 0pt 0pt,margin=-30pt 0pt 0pt 0pt,set height=0pt}{%
                    \includegraphics[width=1.6\linewidth,height=0.9\textheight,keepaspectratio]{\assetdir/basicDocLaTeXSnippet.png}%
                }
            \end{column}%
        \end{columns}
    \end{frame}
    ...
    [label=codeoverview]
        ...
        \parbox[c]{0.6\textwidth}{
            ...
            \only<4-5>{
                \centering
                \includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{\assetdir/wikipediaVisual}
                %\includegraphics[width=\linewidth,height=0.8\textheight,keepaspectratio]{\assetdir/wikipediaVisual2}
            }
            \fi
            \only<6-7>{
                \includegraphics[width=\linewidth]{\assetdir/whatsappStyles2.png}
                
                \bigskip
                
                %\includegraphics[width=\linewidth]{whatsappStylesResultCropped.jpg}
                \includegraphics[width=\linewidth]{\assetdir/whatsappStylesResult2.png}
            }
        }
    \end{frame}
    ...
    \begin{frame}
        ...
        \adjustbox{
            ...
            \includegraphics[
                ...
                height=0.5\textheight,width=0.5\linewidth,keepaspectratio]{\assetdir/wikipediaInfobox.png}%
        }
        \vspace{5pt}
        ...
        \adjustbox{
            ...
            \includegraphics[height=0.5\textheight,width=0.5\linewidth,keepaspectratio]{\assetdir/wikipediaHyperAndFootnotes.png}%
        }
    \end{frame}
